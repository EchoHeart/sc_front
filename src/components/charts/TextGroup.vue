<template>
    <el-row :gutter="60" class="panel-group">
        ...
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
            <div class="card-panel" @click="handleSetLineChartData('scores')">
                <div class="card-panel-icon-wrapper icon-money">
                    <i class="el-icon-video-camera-solid" style="font-size: 50px"></i>
                </div>
                <div class="card-panel-description">
                    <div class="card-panel-text">
                        均分变化
                    </div>
                    <count-to :start-val="0" :end-val="89" :duration="3200" class="card-panel-num" />
                </div>
            </div>
        </el-col>
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
            <div class="card-panel" @click="handleSetLineChartData('questions')">
                ...
                <div class="card-panel-description">
                    ...
                    <count-to :start-val="5" :end-val="70" :duration="3600" class="card-panel-num" />
                </div>
            </div>
        </el-col>
    </el-row>
